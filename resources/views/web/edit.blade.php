                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="member_number" id="name" class="form-control" value="{{ $data->member_number ?? '' }}" required />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="marital_status"
                                        class="form-control">
                                        <option value=""></option>
                                        <option value="married" {{ $data->marital_status == 'married' ? 'selected' : '' }}>Menikah</option>
                                        <option value="single" {{ $data->marital_status == 'single' ? 'selected' : '' }}>Belum Menikah</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="date_of_birth" class="form-control date" value="{{ $data->date_of_birth ?? '' }}"
                                    required >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="date" name="join_date" class="form-control date"  value="{{ $data->join_date ?? '' }}"
                                    required >
                                </div>
                            </div>
